...
export const Footer = () => {
  return (
    <footer className="bg-sky-600 rounded-t-2xl shadow-inner">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Brand Section */}
          <div className="text-center md:text-left">
            <p className={`text-[#3d2700] font-semibold ${audiowide.className}`}>Challenge your mind, test your speed, connect with others.</p>
          </div>

          {/* Quick Links */}
          <div className="text-center">
            <h3 className={`text-[#3d2700] text-lg font-semibold mb-4 ${audiowide.className}`}>Quick Links</h3>
          ...
          <div className="text-center md:text-right text-black">
            <h3 className={`text-[#3d2700] text-lg font-semibold mb-4 ${audiowide.className}`}>Connect With Us</h3>
