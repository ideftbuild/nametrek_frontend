      ...
      <main className="container mx-auto px-4 md:px-8 lg:px-16 py-12 text-white">
        ...
        <div className="text-center mb-16">
          ...
          <div className="mt-8">
            <Link href="/">
              <button
                className="bg-gradient-to-r from-pink-500 to-yellow-500 text-white px-8 py-3 rounded-full font-semibold text-lg hover:opacity-90 transition-opacity flex items-center mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          {[
            ...
            <div key={index} className="bg-gray-800 bg-opacity-50 p-6 rounded-xl backdrop-blur-sm">
